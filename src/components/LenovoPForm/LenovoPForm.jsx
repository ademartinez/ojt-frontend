...
import styles from './LenovoPForm.module.css';
...
const LenovoPForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className={styles.lenovoPForm}>
      <h2 className={styles.title}>Lenovo Parts Request Email Form</h2>
