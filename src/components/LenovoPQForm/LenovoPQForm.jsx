...
import styles from './LenovoPQForm.module.css'; // Importing the CSS module
...
const LenovoPQForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className={styles.lenovoPQForm}>
      <h2 className={styles.title}>Lenovo Parts Quotation Email Form</h2>
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) => handleChange(e, null, 'attendingEngineer')}
          required
        >
